...
<!-- Cart Section -->
<section class="cart-section py-5 bg-light mb-5">
    <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_SESSION['user_username'])) {
                        ...
                        while ($r = mysqli_fetch_assoc($result)) {
                            ...
                            ?>
                            <tr>
                                <td><img src="<?php echo $r['p_main_image']; ?>" class="img-fluid"
                                        alt="<?php echo $r['p_name']; ?>" width="100"></td>
                                <td><?php echo $r['p_name']; ?></td>
                                <td><?php echo $r['sc_name']; ?></td>
                                <td>₹ <?php echo number_format($price, 2); ?></td>
                                <td>
                                    <input type="number" name="quantity[]" class="form-control quantity" style="width: 60px;"
                                        value="1" min="1" data-price="<?php echo $price; ?>"
                                        data-code="<?php echo $r['p_code']; ?>" />
                ...
                <tfoot>
                    <tr>
                        ...
                        echo $grandTotal; ?>" />
                        <td><button class="buy-now" id="toggleFormBtnC">Order Now</button></td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    <!-- checkout form -->
    <div class="container card bgcolor mt-5 p-6" id="formBlockCheckOut" style="display: none;">
        <div class="row p-5">
            <!-- Images Column -->
            <div class="col-md-4">
...
<script>
    document
        .getElementById("toggleFormBtnC")
        .addEventListener("click", function () {
            document.getElementById("formBlockCheckOut").style.display =
                document.getElementById("formBlockCheckOut").style.display === "none"
                    ? "block"
                    : "none";
        });
