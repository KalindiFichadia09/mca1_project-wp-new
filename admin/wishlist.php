...
<div class="container mt-5 pt-2">
    <div class="row mt-5 mb-4 align-items-center">
        ...
        <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-start mb-2 mb-md-0">
            <h2 class="text-center text-md-left">Manage Wishlist</h2>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                        ...
                        $q_count = "SELECT COUNT(*) AS total FROM wishlist_tbl $search_query";
                        ...
                        $q = "SELECT * FROM wishlist_tbl $search_query LIMIT $start_from, $records_per_page";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                ?>
                                <tr>
                                    <!-- <td><?php echo $r['w_id']; ?></td> -->
                                    <td><?php echo $sr_no++; ?></td>
                                    <td><?php echo $r['w_code']; ?></td>
                                    <td><?php echo $r['w_username']; ?></td>
                                    <td><?php echo $r['w_p_code']; ?></td>
                                    <td>₹ <?php echo number_format($r['w_p_tot_price'], 2); ?></td>
                                </tr>
                                <?php
                            }
                        } else {
