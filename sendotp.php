        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm p-4">
                    ...
                    <form action="sendotp.php" onsubmit="return forgotPassword_validation()" method="get">
                        <div class="form-group">
                            <label for="email">Enter OTP</label>
                            <input type="email" id="email" class="form-control" id="email" placeholder="Enter otp">
